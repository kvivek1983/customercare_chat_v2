...
@Component({
  selector: 'app-dco-active-approved-view',
  standalone: true,
  imports: [NgTemplateOutlet, CommonModule, FormsModule, ReactiveFormsModule, RemoveBrPipe, ReplaceArrowPipe],
  templateUrl: './dco-active-approved-view.component.html',
  styleUrl: './dco-active-approved-view.component.scss'
})
export class DcoActiveApprovedViewComponent {
